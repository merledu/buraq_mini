...
#endif
#include <iostream>
class Harness_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    Harness_api_t(VHarness* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["Harness.reset"] = 0;
    }
#if VM_TRACE
...
int main(int argc, char **argv, char **env) {
    ...
    std::string vcdfile = "test_run_dir/it_should_work/Harness.vcd";
    ...
    Verilated::mkdir("test_run_dir/it_should_work/logs");
    VerilatedCov::write("test_run_dir/it_should_work/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}
